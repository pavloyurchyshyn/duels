...
# --------- SKIN SETTINGS ---------------
def reload_color():
    face_color = (int(FACE_INPUT_R.text), int(FACE_INPUT_G.text), int(FACE_INPUT_B.text), 255)
    body_color = (int(BODY_INPUT_R.text), int(BODY_INPUT_G.text), int(BODY_INPUT_B.text), 255)
...
PLAYER_PIC = SimplePlayer(1500, 100, turn_off_camera=True, size=PLAYER_SIZE * 5, player_color=__player_color)

FACE_INPUT_R = InputElement(1250, 100, text=f'{f_r}', size_x=50, size_y=40,
                            text_active_color=GREY_RED)
FACE_INPUT_G = InputElement(1250, 150, text=f'{f_g}', size_x=50, size_y=40,
                            text_active_color=GREY_GREEN)
FACE_INPUT_B = InputElement(1250, 200, text=f'{f_b}', size_x=50, size_y=40,
                            text_active_color=GREY_BLUE)
BODY_INPUT_R = InputElement(1250, 300, text=f'{b_r}', size_x=50, size_y=40,
                            text_active_color=GREY_RED)
BODY_INPUT_G = InputElement(1250, 350, text=f'{b_g}', size_x=50, size_y=40,
                            text_active_color=GREY_GREEN)
BODY_INPUT_B = InputElement(1250, 400, text=f'{b_b}', size_x=50, size_y=40,
                            text_active_color=GREY_BLUE)
